...
description: How to authenticate with the Subvima CLI
icon: Key
---

Before you can start a tunnel, you need to authenticate with your Subvima account. This ensures that your tunnels are secure and associated with your user profile.
...
1.  Open your default web browser to the Subvima dashboard.
...
1.  Go to your [Organization Settings](https://Subvima.dev/settings) in the dashboard.
2.  Generate a new API Key.
3.  Use the `--key` flag when running commands:

```bash
Subvima 3000 --key SUBVIMA_sk_...
```
