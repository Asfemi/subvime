      ...
      <div className="grid gap-8">
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-white/5 border border-white/5 p-8 backdrop-blur-sm transition-all hover:bg-white/10">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 mb-6 max-w-xl">
              Install the Subvima CLI globally using npm. This will allow you to
            ...
            <div className="bg-black/50 rounded-xl border border-white/10 p-4 flex items-center justify-between group/code">
              <code className="font-mono text-accent">npm i -g Subvima</code>
              <button
                onClick={() =>
                  navigator.clipboard.writeText("npm install -g Subvima")
                }
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-white/5 border border-white/5 p-8 backdrop-blur-sm transition-all hover:bg-white/10">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-4">
              <div className="bg-black/50 rounded-xl border border-white/10 p-4 flex items-center justify-between group/code">
                <code className="font-mono text-accent">Subvima login</code>
                <button
                  onClick={() => {
                    navigator.clipboard.writeText("Subvima login");
                    setCopied(true);
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-white/5 border border-white/5 p-8 backdrop-blur-sm transition-all hover:bg-white/10">
          ...
          <div className="relative z-10">
            ...
            <div className="bg-black/50 rounded-xl border border-white/10 p-4 flex items-center justify-between group/code">
              <code className="font-mono text-accent">Subvima 3000</code>
              <button
                onClick={() => navigator.clipboard.writeText("Subvima 3000")}
                className="p-2 rounded-lg hover:bg-white/10 text-gray-400 hover:text-white transition-colors opacity-0 group-hover/code:opacity-100"
              >
                <Copy size={18} />
              </button>
