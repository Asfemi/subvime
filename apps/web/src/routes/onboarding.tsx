...
export const Route = createFileRoute("/onboarding")({
  head: () => ({
    meta: [
      { title: "Create Organization - Subvima" },
    ],
  }),
        ...
        if (data.available) {
          ...
          setError(
            data.reason === "reserved"
              ? "This slug is reserved. Contact support@Subvima.dev to claim it."
  ...
  if (sessionPending) {
    return (
      <div className="fixed inset-0 bg-black flex items-center justify-center">
        <img src="/logo.png" alt="Subvima" className="w-16 h-16 animate-pulse" />
      </div>
    );
  }
