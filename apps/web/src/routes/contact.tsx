...
function ContactPage() {
  ...
  const emails = [
    { label: "Support", email: "support@Subvima.dev", icon: Mail, description: "Questions & help" },
    { label: "Partnerships", email: "hey@Subvima.dev", icon: Handshake, description: "Business inquiries" },
    { label: "Security", email: "security@Subvima.dev", icon: Shield, description: "Report vulnerabilities" },
  ];
