...
export const emailTemplates: EmailTemplates = {
  welcome: {
    name: "Welcome Email",
    subject: "Welcome to Subvima!",
    params: ["name", "dashboardUrl"],
    previewParams: {
      name: "John Doe",
      dashboardUrl: "https://Subvima.dev/select",
    },
...
<head>
  ...
  <title>Welcome to Subvima</title>
</head>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px;">
          <tr>
            <td style="padding: 0 0 20px 0;">
              ...
              <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 24px; color: #3f3f46;">
                I'm Akinkunmi, the creator of Subvima. I'm happy to have you onboard! <br/> <br/> Subvima makes it easy to expose your local development servers to the internet securely.
              </p>
          ...
          <tr>
            <td style="padding: 20px 0 0 0; border-top: 1px solid #e4e4e7;">
              <p style="margin: 0; font-size: 14px; color: #71717a;">
                © 2026 Subvima. All rights reserved.
              </p>
            </td>
          </tr>
        </table>
...
`,
  ...
  "password-reset": {
    ...
    previewParams: {
      name: "John Doe",
      resetUrl: "https://Subvima.dev/reset-password?token=abc123",
    },
    html: ({ name, resetUrl }) => `
<!DOCTYPE html>
<html lang="en">
...
`,
  ...
  "organization-invite": {
    ...
    subject: ({ organizationName }) =>
      `You're invited to join ${organizationName} on Subvima`,
    params: ["inviterName", "organizationName", "role", "invitationLink"],
    previewParams: {
      inviterName: "Jane Smith",
      organizationName: "Acme Corp",
      role: "member",
      invitationLink: "https://Subvima.dev/invitations/accept?token=abc123",
    },
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px;">
          ...
          <tr>
            <td style="padding: 0 0 20px 0;">
              ...
              <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 24px; color: #3f3f46;">
                <strong>${inviterName}</strong> has invited you to join the organization <strong>${organizationName}</strong> on Subvima with the role of <strong>${role}</strong>.
              </p>
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 24px; color: #3f3f46;">
...
`,
  ...
  "payment-failed": {
    name: "Payment Failed",
    subject: "Action Required: Your Subvima payment failed",
    params: ["name", "planName", "amount", "billingUrl", "attemptsRemaining"],
    previewParams: {
      name: "John Doe",
      planName: "Beam",
      amount: "₦21,000",
      billingUrl: "https://Subvima.dev/acme/billing",
      attemptsRemaining: 2,
    },
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px;">
          ...
          <tr>
            <td style="padding: 0 0 20px 0;">
              ...
              <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 24px; color: #3f3f46;">
                We couldn't process your payment of <strong>${amount}</strong> for the <strong>${planName}</strong> plan on Subvima.
              </p>
              <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 24px; color: #3f3f46;">
                ${attemptsRemaining > 0
...
`,
  ...
  "subscription-reset": {
    ...
    previewParams: {
      ...
      previousPlan: "Ray",
      dashboardUrl: "https://Subvima.dev/acme/settings",
    },
