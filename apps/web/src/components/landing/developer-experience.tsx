          ...
          {activeTab === "vite" ? (
            <pre className="text-white/70">
              <code>
                ...
                <span className="text-green-400/80">'@Subvima/vite'</span>;{"\n\n"}
            ...
            <pre className="text-white/70">
              <code>
                <span className="text-accent">import</span> withSubvima{" "}
                <span className="text-accent">from</span>{" "}
                <span className="text-green-400/80">'@Subvima/next'</span>;{"\n\n"}
                <span className="text-accent">export default</span> withSubvima({"{"}
                {"\n"}
            ...
            <pre className="text-white/70">
              <code>
                ...
                <span className="text-accent">import</span> Subvima{" "}
                <span className="text-accent">from</span>{" "}
                <span className="text-green-400/80">'@Subvima/express'</span>;{"\n\n"}
        ...
        <div className="grid gap-8">
          <div className="bg-white/2 border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors group flex flex-col">
            ...
            <div className="bg-black/40 rounded-2xl border border-white/5 p-4 font-mono text-sm mt-auto">
              <span className="text-accent">$</span> Subvima 3000
            </div>
          </div>
          ...
          <div className="bg-white/2 border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors group flex flex-col">
            ...
            <p className="text-white/40 mb-6">
              Use our plugins to embed Subvima directly into your build tool.
            </p>
            <PluginTabs />
          </div>
        </div>
