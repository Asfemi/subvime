          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                By accessing or using Subvima's services, website, CLI tools, or
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                Subvima provides secure tunneling services that allow developers
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                ...
                owned by Subvima and protected by intellectual property laws. You
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, Subvima SHALL NOT BE
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                You agree to indemnify and hold harmless Subvima, its officers,
