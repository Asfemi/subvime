import { SiMongodb, SiPostgresql, SiRedis, SiSocketdotio, SiStripe, SiTwilio } from "react-icons/si";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-white/40 max-w-2xl mx-auto">
            The Subvima Express plugin works seamlessly with your favorite databases, webhooks, and APIs.
          </p>
        </motion.div>
