...
export const ExpressHero = () => {
  ...
  const copyCommand = () => {
    navigator.clipboard.writeText("npm install @Subvima/express");
    setCopied(true);
    ...
    <div className="relative min-h-[80vh] flex flex-col justify-center items-center pt-32 pb-16 overflow-hidden">
      ...
      >
        ...
        >
          <div ref={logoRef} className="relative" style={{ perspective: "1000px" }}>
            ...
            >
              ...
              >
                <SiExpress className="w-14 h-14 text-white" />
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <p className="text-xl md:text-2xl text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          The official Subvima plugin for Express. Automatically creates a public tunnel 
          when your server starts. No CLI required.
        </p>
        ...
        >
          <span className="text-accent">$</span> npm install @Subvima/express
          {copied ? (
