...
export const ViteHero = () => {
  ...
  const copyCommand = () => {
    navigator.clipboard.writeText("npm install @Subvima/vite");
    setCopied(true);
    ...
    <div className="relative min-h-[80vh] flex flex-col justify-center items-center pt-32 pb-16 overflow-hidden">
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          The official Subvima plugin for Vite. Automatically creates a public tunnel 
        ...
        >
          <span className="text-accent">$</span> npm install @Subvima/vite
          {copied ? (
      ...
      >
        <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-6">
          <p className="text-white/70 text-lg leading-relaxed mb-4">
            "Awesome to see Subvima focus on the Vite ecosystem to provide 
