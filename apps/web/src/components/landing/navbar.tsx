...
export const Navbar = () => {
  ...
  const downloadLogoAsSvg = (variant: 'light' | 'dark') => {
    ...
    a.href = url;
    a.download = `Subvima-logo-${variant}.svg`;
  ...
  const downloadAllAssets = () => {
    const a = document.createElement('a');
    a.href = '/Subvima-brand-assets.zip';
    a.download = 'Subvima-brand-assets.zip';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    setLogoContextMenu(null);
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-6">
          ...
          >
            <img src="/logo.png" alt="Subvima Logo" className="w-10" />
          </Link>
          <button
            onClick={() => setMobileMenuOpen(false)}
        ...
        <div className="flex flex-col h-[calc(100%-80px)] px-6 pb-8">
          <div className="flex flex-col gap-2 flex-1">
            ...
            <a
              href="https://github.com/akinloluwami/Subvima"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => setMobileMenuOpen(false)}
            ...
            <div className="py-4 border-b border-white/10">
              ...
              <div className="flex flex-col gap-2 pl-2">
                ...
                <a
                  href="https://github.com/akinloluwami/Subvima/issues/new"
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => setMobileMenuOpen(false)}
                  className="flex items-center gap-3 text-white/70 hover:text-white transition-colors py-2 text-lg"
