...
export const REVENUE_BACKGROUNDS = [
  ...
  { type: "image", value: "https://assets.Subvima.dev/bgs/001.jpg" },
  { type: "image", value: "https://assets.Subvima.dev/bgs/002.jpg" },
  { type: "image", value: "https://assets.Subvima.dev/bgs/003.jpg" },
  { type: "image", value: "https://assets.Subvima.dev/bgs/004.jpeg" },
];
...
export function ShareRevenueModal({
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.download = `Subvima-revenue-${new Date().toISOString().split("T")[0]}.png`;
      link.href = dataUrl;
      link.click();
    } catch (error) {
      // Restore rounded corners on error
