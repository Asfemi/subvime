...
import { y as parseRedirect, z as mergeHeaders, m as isRedirect, A as resolveManifestAssetLink, s as resolveManifestCssLink, C as defineHandlerCallback, k as rootRouteId, D as getNormalizedURL, E as getOrigin, F as createSerializationAdapter, G as normalizeSsrResponse, H as attachRouterServerSsrUtils, I as createRawStreamRPCPlugin, i as invariant, g as isNotFound, J as isResolvedRedirect, K as replaceSsrResponse, L as executeRewriteInput, M as stripSsrResponseBody, N as defaultSerovalPlugins, O as makeSerovalPlugin, t as getScriptPreloadAttrs, P as getStylesheetHref, Q as isSsrResponse } from "../_chunks/_libs/@tanstack/router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-jdZYmb9K.mjs");
...
const manifest = {
  "417dfdc82c6abd96da65bb8d9bf9b610ec5cbb2c68e139242b562aaf83b39e0b": {
    functionName: "loadSharedChecklist_createServerFn_handler",
    importer: () => import("./_shareId-CbZYhXKa.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BqhhCnjO.mjs").then((n) => n.r),
