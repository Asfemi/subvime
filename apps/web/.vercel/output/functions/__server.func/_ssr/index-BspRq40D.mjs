...
import { I as Input, B as Button } from "./input-CSALrFrJ.mjs";
import { B as Badge } from "./badge-CBjMOr_d.mjs";
import { d as countChecklistSteps, e as cloneChecklistFromTemplate, f as generateStepsFromTaskInput, h as createChecklistId, p as parseChecklistImport } from "./shared-checklists-BJQo8yU4.mjs";
import { F as FEATURED_CHECKLISTS, f as featuredToSteps } from "./router-LHZOSFRh.mjs";
...
function FeaturedChecklistsSection({ onUse, usingId }) {
...
function LlmInstructionsPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-white/5 pb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
...
function AppHomePage() {
  ...
  const [usingFeaturedId, setUsingFeaturedId] = reactExports.useState(null);
  ...
  const handleUseFeatured = async (featured) => {
    if (!userId) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-black text-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-6xl px-4 pb-12 pt-20 sm:px-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mb-4 text-lg font-medium", children: "Checklists" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedChecklistsSection, { onUse: handleUseFeatured, usingId: usingFeaturedId }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 grid gap-6 border-t border-white/5 pt-6 lg:grid-cols-[minmax(0,320px)_1fr] lg:items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TaskInputForm, { onSubmit: handleCreate, isLoading: creating }),
